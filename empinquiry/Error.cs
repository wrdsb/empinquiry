        ...
        public void handleError(Exception exception, string emailText)
        {
            ...
            try
            {
                ...
                if (emailText != "Exception occured attempting to send email.")
                {
                    ...
                    email.SendEmail(WebConfigurationManager.AppSettings["EmailAddressNotify"].ToString(), WebConfigurationManager.AppSettings["loginTitle"].ToString() + " Exception", emailText);
